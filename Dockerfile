...
RUN apt-get install -y php5-fpm php-gettext php5 php5-common php5-curl php5-gd php5-imagick php5-intl php5-json php5-mcrypt php5-mysqlnd php5-readline php5-tidy php5-xmlrpc
